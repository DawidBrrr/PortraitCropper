...
class Cropper():
    ...
    def crop_align(
            ...
            #translation: tuple[int, int] = (0,0),  # New argument for translation
    ) -> np.ndarray:
        """Aligns and center-crops faces based on the given landmarks with optional translation.
        ...
        following actions:
            ...
            3. Applies transformation to align and center-crop the face
               based on the face factor, with optional translation.
            4. Returns a batch of face images represented as numpy
               arrays of the same length as the number of sets of
               landmarks.

        Args:
            images: Image batch of shape (N, H, W, 3) of type
                :attr:`numpy.uint8` where each nth image is transformed
                to extract face(-s). It can also be a list of
                :attr:`numpy.uint8` numpy arrays of different shapes.
            ...
            translation: A tuple (x_offset, y_offset) representing the
                translation in pixels to move the cropping area
                horizontally (x_offset) and vertically (y_offset).
        ...
        Returns:
            ...
            shape (N, H, W) of type :attr:`numpy.uint8`. (H, W) is defined
            by ``self.output_size``.
        """
        ...
        for landmarks_idx, image_idx in enumerate(indices):
            if self.allow_skew:
                ...
                # Perform only rotation, scaling and translation
            ...
            # Add translation directly to the transformation matrix
            transform_matrix[0, 2] += self.translation[0]
            transform_matrix[1, 2] += self.translation[1]
