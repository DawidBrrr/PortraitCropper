...
#CroppingProgressPopup
class CroppingProgressBarPopup(ctk.CTkToplevel):
...
class RotateProgressBarPopup(ctk.CTkToplevel):
    def __init__(self,master):
        ...
        # progressbar
        self.rotate_progress_bar = ctk.CTkProgressBar(self, orientation="horizontal", mode="indeterminate")
        self.rotate_progress_bar.grid(row=0, column=0, padx=20, pady=20, sticky="sew", columnspan=2)
        self.rotate_progress_bar.start()
        # napis
        self.rotating_label = ctk.CTkLabel(self, text="Obracanie", fg_color="gray16", corner_radius=6,
                                           text_color="white", font=self.text_font)
        self.rotating_label.grid(row=1, column=0, padx=20, pady=20, sticky="sew", columnspan=2)
